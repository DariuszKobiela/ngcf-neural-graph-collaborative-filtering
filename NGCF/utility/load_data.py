...
class Data(object):
    def __init__(self, path, batch_size, results_file_to_write):
        self.path = path
        self.batch_size = batch_size
        self.results_file_to_write = results_file_to_write
    ...
    def print_statistics(self):
        ...
        with open(self.results_file_to_write, 'a') as f:
            f.write(f'\n')
            f.write(f'n_users={self.n_users}, n_items={self.n_items} \n')
            f.write(f'n_interactions={self.n_train + self.n_test} \n')
            f.write(f'n_train={self.n_train}, n_test={self.n_test}, sparsity={(self.n_train + self.n_test) / (self.n_users * self.n_items)} \n')